...
describe('to sql', function () {
  ...
  it('nested combination test', () => {
    const ast = parse('t[eq]=q;(a[eq]=b,c[ne]=d)');
  ...
  it('test tablenames', () => {
    const ast = parse('a.b.c[eq]=b;a[eq]=1,t.t.t[eq]=1,werwerr.er[op]=(1,2,3);a[eq]=1');
  ...
  it('test validate', () => {
    ...
    sql.validate('a.b.c[eq]=b;a[eq]=1,t.t.t[eq]=1,w.r[op]=(1,2,3);a[eq]=1', selectors);
  });
